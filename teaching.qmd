...
In Fall 2025 I am teaching Mathematical Analysis II (Math 132) and Ordinary Differential Equations (Math 82). I am also the Math Thesis Coordinator for the 2025--2026 academic year.
...
ODEs can be used to describe dynamic phenomena in the world around us. In this course, we model physical systems using ODEs by identifying assumptions and deriving ODEs from physical laws. We introduce techniques to analyze and solve these equations along with theoretical foundations for the subject. We study ODEs from a variety of mathematical perspectives (e.g., geometric, analytic, state space vs time series).
...
- Fundamental matrices and the matrix exponential
- Bifurcations
